...
const HomePage = () => {
  return (
    <section className="flex flex-col items-center gap-4">
      <HomePageHeader />
      <div className="border-2 border-black p-4 h-96 w-96 bg-amber-300"></div>
      <div className="border-2 border-black p-4 h-96 w-96 bg-amber-500"></div>
      <div className="border-2 border-black p-4 h-96 w-96 bg-amber-700"></div>
...
export default function Home() {
  return (
    <div className="overflow-hidden py-32 px-2 flex justify-center items-center ">
